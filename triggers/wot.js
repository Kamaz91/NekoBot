...
function wot(message, trigger) {
    ...
    var drwal = function (message, trigger) {
        ...
        for (var lp in trigger.splitTigger) {
            dd(message, trigger, lp);
        }

    };
    var dd = function (message, trigger, lp) {
    ...
    var getProfile = function (message, trigger) {
        request({
